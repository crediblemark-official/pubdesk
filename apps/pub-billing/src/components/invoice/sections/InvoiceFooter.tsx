              ...
              <div xmlns="http://www.w3.org/1999/xhtml" style={{
                ...
                {profile.companyWebsite && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                    <img src="data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='%23ffffff' stroke-width='2.5' stroke-linecap='round' stroke-linejoin='round'><circle cx='12' cy='12' r='10'></circle><line x1='2' y1='12' x2='22' y2='12'></line><path d='M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z'></path></svg>" style={{ width: '11px', height: '11px', flexShrink: 0, opacity: 0.95 }} alt="Website" />
                    <span>{profile.companyWebsite}</span>
                  </div>
                )}
                {profile.companyEmail && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                    <img src="data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='%23ffffff' stroke-width='2.5' stroke-linecap='round' stroke-linejoin='round'><path d='M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z'></path><polyline points='22,6 12,13 2,6'></polyline></svg>" style={{ width: '11px', height: '11px', flexShrink: 0, opacity: 0.95 }} alt="Email" />
                    <span>{profile.companyEmail}</span>
                  </div>
                )}
                {profile.companyYoutube && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                    <img src="data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='%23ffffff' stroke-width='2.5' stroke-linecap='round' stroke-linejoin='round'><path d='M22.54 6.42a2.78 2.78 0 0 0-1.95-1.96C18.88 4 12 4 12 4s-6.88 0-8.59.46a2.78 2.78 0 0 0-1.95 1.96A29 29 0 0 0 1 11.75a29 29 0 0 0 .46 5.33 2.78 2.78 0 0 0 1.95 1.96C5.12 19.5 12 19.5 12 19.5s6.88 0 8.59-.46a2.78 2.78 0 0 0 1.95-1.96A29 29 0 0 0 23 11.75a29 29 0 0 0-.46-5.33z'></path><polygon points='9.75 15.02 15.5 11.75 9.75 8.48 9.75 15.02'></polygon></svg>" style={{ width: '11px', height: '11px', flexShrink: 0, opacity: 0.95 }} alt="Youtube" />
                    <span>{profile.companyYoutube}</span>
                  </div>
                )}
                {profile.companyInstagram && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                    <img src="data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='%23ffffff' stroke-width='2.5' stroke-linecap='round' stroke-linejoin='round'><rect x='2' y='2' width='20' height='20' rx='5' ry='5'></rect><path d='M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z'></path><line x1='17.5' y1='6.5' x2='17.51' y2='6.5'></line></svg>" style={{ width: '11px', height: '11px', flexShrink: 0, opacity: 0.95 }} alt="Instagram" />
                    <span>{profile.companyInstagram}</span>
                  </div>
                )}
                {profile.companyPhone && (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                    <img src="data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='%23ffffff' stroke-width='2.5' stroke-linecap='round' stroke-linejoin='round'><path d='M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z'></path></svg>" style={{ width: '11px', height: '11px', flexShrink: 0, opacity: 0.95 }} alt="Telepon" />
