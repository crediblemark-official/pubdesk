...
export const InvoiceFooter: React.FC<InvoiceFooterProps> = ({
  ...
  return (
    <>
      ...
      {/* Footer SVG */}
      <div className="invoice-footer" style={{ flexShrink: 0, marginTop: 'auto' }}>
        <svg
          viewBox="0 0 1045 80"
        ...
        >
          ...
          {profile?.showFooterBranding !== false && profile?.footerNoteText && (
            <text
              x="61"
              y="49"
              fill="#ffffff"
