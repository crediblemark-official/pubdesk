        ...
        <form onSubmit={handleAddLocalFolder} style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
          <div className="compact-form-group">
            ...
            <div style={{ display: 'flex', gap: '6px' }}>
              ...
              <button type="submit" disabled={addingFolder || !localPathInput.trim()} className="btn-primary compact-btn" style={{ height: '32px', display: 'flex', alignItems: 'center', justifyContent: 'center', whiteSpace: 'nowrap', cursor: 'pointer' }}>
