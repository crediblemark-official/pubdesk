        ...
        <div 
          ...
          <div className="invoice-header" style={{ flexShrink: 0 }}>
            ...
            >
              ...
              <rect x="267" y="20" width="390" height="78" fill={headerBgColor} />

              {/* Bidang merah utama (Warna dinamis) - Sejajar dengan panel hitam y=20 ke y=98 */}
              <polygon points="0,20 220,20 264.5,98 0,98" fill={headerPrimaryColor} />

              {/* Pemisah putih agar warna hitam tidak menyelip - Diperpanjang membungkus */}
              <polygon points="208.6,0 224.6,0 283.9,104 267.9,104" fill="#ffffff" />

              {/* Aksen merah kedua (Warna dinamis) - Diperpanjang membungkus */}
              <polygon points="224.6,0 259.3,0 320,104 283.9,104" fill={headerSecondaryColor} />
              ...
              {activeProfile?.companyLogo ? (
                ...
                <>
                  ...
                  {/* Nama perusahaan */}
                  <text x="88" y="48" fill="#ffffff" fontFamily="Arial, sans-serif" fontSize="15" fontWeight="700" letterSpacing="1.4">
                    {activeProfile?.companyName || 'CV KBM'}
                  </text>
                  <text x="89" y="62" fill="#ffffff" fontFamily="Arial, sans-serif" fontSize="7" fontWeight="600" letterSpacing="1.8">
              ...
              {/* Judul invoice */}
              <text x="622" y="64" textAnchor="end" fill="#ffffff" fontFamily="Arial, sans-serif" fontSize="44" fontWeight="700" letterSpacing="2">
                {activeProfile?.invoiceTitleText || 'INVOICE'}
              </text>

              {/* Nomor invoice di bawah judul */}
              <text x="622" y="84" textAnchor="end" fill="#dddddd" fontFamily="Arial, sans-serif" fontSize="10" fontWeight="700" letterSpacing="1">
