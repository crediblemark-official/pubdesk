...
const defaultProfiles: InvoiceProfile[] = [
  {
    id: 'cetak_buku_ongkir',
    name: 'Cetak Buku & Ongkos Kirim (Bawaan)',
    companyName: 'NAMA PERUSAHAAN',
    companyTagline: 'TAGLINE PERUSAHAAN',
    invoiceTitleText: 'INVOICE & TAGIHAN BIAYA',
    accentColor: '#d93838',
    accentColorDark: '#991b1b',
    ...
    tableType: 'cetak_buku_ongkir',
    notes: [
      'Jika terkait pajak maka pajak ditanggung penulis atau pemesan.',
      'Fasilitas sesuai paket yang diambil.'
    ],
    showSpesifikasi: false,
    defaultSpesifikasi: '',
    signatureOffice: 'Kantor Penerbit',
    signatureLocation: 'Kota',
    signatureRole: 'CEO / Direktur',
  ...
  {
    id: 'pengajuan_haki',
    name: 'Pengajuan HAKI (Bawaan)',
    companyName: 'NAMA LEMBAGA/PERUSAHAAN',
    companyTagline: 'TAGLINE PERUSAHAAN',
    invoiceTitleText: 'INVOICE & TAGIHAN BIAYA PENERBITAN',
    accentColor: '#d93838',
    accentColorDark: '#991b1b',
    headerBgColor: '#222933',
    headerPrimaryColor: '#d93838',
    headerSecondaryColor: '#d93838',
    defaultHal: 'Pengajuan HAKI',
    defaultLampiran: '-',
    salamPembuka: 'Bersama surat ini kami memberikan gambaran rincian biaya Pengajuan HAKI dengan ketentuan sebagai berikut:',
    actionLabel: 'pengajuan HAKI',
    tableType: 'haki',
    notes: [
      'Jika terkait pajak maka pajak ditanggung penulis atau pemesan.',
      'Fasilitas sesuai paket yang diambil.'
    ...
    showSpesifikasi: false,
    defaultSpesifikasi: '',
    signatureOffice: 'Kantor Administrasi',
    signatureLocation: 'Kota',
    signatureRole: 'CEO / Direktur',
    signatureName: 'NAMA PENANDATANGAN',
    showBankInfo: true,
    ...
    headerType: 'logo_text',
    tableColumns: [
      { key: 'item_title', label: 'Judul Karya', type: 'text', align: 'left' },
  ...
  {
    id: 'penerbitan_buku',
    name: 'Penerbitan Buku - Tanpa Ongkir (Bawaan)',
    companyName: 'NAMA PERUSAHAAN',
    companyTagline: 'TAGLINE PERUSAHAAN',
    invoiceTitleText: 'INVOICE & TAGIHAN BIAYA PENERBITAN',
    accentColor: '#f59e0b',
    ...
    headerBgColor: '#222933',
    headerPrimaryColor: '#f59e0b',
    headerSecondaryColor: '#f59e0b',
    defaultHal: 'Biaya Penerbitan Buku',
    defaultLampiran: '-',
    salamPembuka: 'Bersama surat ini kami memberikan gambaran rincian biaya Penerbitan Buku dengan ketentuan sebagai berikut:',
    actionLabel: 'penerbitan buku',
    tableType: 'spt_tanpa_ongkir',
    notes: [],
    showSpesifikasi: true,
    defaultSpesifikasi: 'Sesuai poster paket yang diambil',
    signatureOffice: 'Kantor Penerbit',
    signatureLocation: 'Kota',
    ...
    tableColumns: [
      ...
      { key: 'pages', label: 'Hal', type: 'text', align: 'center', width: '80px' },
      { key: 'paper_type', label: 'Jenis Naskah', type: 'text', align: 'center', width: '90px' },
      { key: 'qty_desc', label: 'Jml. Cetak', type: 'formula', align: 'center', width: '130px', formula: '{quantity} pcs ({package_name})' },
      { key: 'price', label: 'Harga Paket', type: 'currency', align: 'right', width: '110px' }
    ]
  },
  {
    id: 'penerbitan_buku_ongkir',
    name: 'Penerbitan Buku - Dengan Ongkir (Bawaan)',
    companyName: 'NAMA PERUSAHAAN',
    companyTagline: 'TAGLINE PERUSAHAAN',
    invoiceTitleText: 'INVOICE & TAGIHAN BIAYA PENERBITAN',
    accentColor: '#f59e0b',
    ...
    tableColumns: [
      ...
      { key: 'price', label: 'Harga Paket', type: 'currency', align: 'right', width: '110px' },
      { key: 'item_shipping_cost', label: 'Ongkos Kirim', type: 'currency', align: 'right', width: '100px' },
      { key: 'total', label: 'Total Biaya', type: 'formula', align: 'right', width: '110px', formula: '{price} + {item_shipping_cost}' }
    ]
  }
];
